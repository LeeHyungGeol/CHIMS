		...
		<div class="main" align="center">
			<div class="container">
				<form class="form-horizontal" action="adminMemberUpdate.do"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" id="firstName" placeholder="ID"
								...
								value="${memberUpdate.member_id}" autofocus>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="password" id="lastName" placeholder="password"
								class="form-control" name="member_pwd" value="aaaa" autofocus>
						</div>
					</div>
					<div class="form-group">
					...
					<a href="adminMemberDelete.do"><button class="btn btn-primary ">삭제</button></a>
				</form>
				<!-- /form -->
			</div>
			<!-- ./container -->
